...
def get_hubert_model():
  # vec_path = "/workspace/so-vits-svc-4.0-v2-main/hubert/checkpoint_best_legacy_500.pt"
  ...
  # )
  # model = models[0]
  hubert_soft = hubert_model.hubert_soft("/data2/spjune/sovits/hubert-soft-0d54a1f4.pt")
  hubert_soft.eval()
  return hubert_soft
...
def get_hparams(init=True):
  ...
  parser.add_argument('-c', '--config', type=str, default="/workspace/silent_speech_icassp/so-vits-svc-main/configs/config.json", help='JSON file for configuration')
  parser.add_argument('-m', '--model', type=str, default="16k",  help='Model name')

  args = parser.parse_args()
  model_dir = os.path.join("/exp_result/sovits/emg_single_sovits/logs_9_11", args.model) ########## 중요 
