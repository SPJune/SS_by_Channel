...
def main(cfg:DictConfig):
    ...
    output_dir = os.path.join(cfg.exp_path, 'toplines', 'mel_bottleneck')
    os.makedirs(output_dir, exist_ok=True)
    path_list = glob(os.path.join(cfg.data_path, 'preprocessed/target_feature/mspec/sr16000/dev/voiced_parallel_data/*/*.npy'))
    path_list.sort()
